...
const moonIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-moon-stars-fill" viewBox="0 0 16 16">
...
const sunIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-sun-fill" viewBox="0 0 16 16">
...
const themeAttribute = document.body.attributes[0];

// Function to swap theme
function themeSwap() {
    if (themeAttribute.value == "dark") {
        themeAttribute.value = "light";
    } else {
        themeAttribute.value = "dark";
    }
}

// Function to change btn-light and text-bg-white to dark
function colourSwap() {
    // Change colour
    if (themeAttribute.value == "light") {
...
function iconSwap() {
    if (themeBtn.querySelector(".bi").classList.contains("bi-sun-fill")) {
