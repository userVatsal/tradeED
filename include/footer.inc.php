<footer class="container" <?php $webpage->disableFooter(); ?>>
    <div class="row d-flex justify-content-start">
        ...
        <div class="col-6 col-md-2 mb-3">
            <h5>Other</h5>
            <ul class="nav flex-column">
                <li class="nav-item mb-2"><a href="../pages/policy.php" class="nav-link p-0 text-muted">Privacy Policy</a></li>
                <li class="nav-item mb-2"><a href="../pages/tcs.php" class="nav-link p-0 text-muted">Terms & Conditions</a></li>
            </ul>
        </div>

        <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
            <p>© 2024 TradeED, Inc. All rights reserved.</p>
